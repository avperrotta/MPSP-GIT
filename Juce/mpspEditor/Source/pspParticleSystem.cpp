...
void pspParticleSystem::setup(pspParticleSystemsManager* sm, String n, int np){
    ...
    specificSetup();
    myGui = new pspParticleSystemGUI(this);
    myGui->setSpecificComponent(mySpecificGui);
...
pspParticleSystemsManager* pspParticleSystem::getSystemsManager(){
...
String pspParticleSystem::getFullName(){
    return type + ":" + name;
}
...
Component* pspParticleSystem::getSpecificGUIComponent(){
    return mySpecificGui;
}


void pspParticleSystem::saveXml(juce::File xmlFile){
    
}

void pspParticleSystem::loadXml(juce::File xmlFile){
    
}

void pspParticleSystem::resetTime(){
    for(int i=0; i<particles->size(); i++){
...
void pspParticleSystem::setBounds(int l, double val){
